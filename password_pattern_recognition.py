# -*- coding: utf-8 -*-
"""
Created on Fri Sep 14 23:25:29 2018
...
def CheckLogin():
    ...
    if tw == cmp and t1<=totaltime and totaltime<=t2:
        ...
        logoutB = Button(r1, text='Exit', command=wel,fg="black",bg="#EA7317",height=3,width=20)
...
def pas():
    ...
    w1.place(relx=0.2,rely=0.2)   
    
    we = Entry(roots,bg="lightgrey",highlightthickness=2,highlightbackground="grey")
    we.place(relx=0.47,rely=0.23)
    
    wb = openpyxl.load_workbook('datap.xlsx')
    ws = wb['Sheet1']
...
def analysis():
    ...
    photo1 = PhotoImage(file="analy1.png")
